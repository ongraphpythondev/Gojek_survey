    ...
    try:
        ...
        try:
            ...
            democratic_form, created = DemocraticOpinion2.objects.get_or_create(
                ...
                source_social_media=form.cleaned_data["source_social_media"],
                source_news_channels=form.cleaned_data["source_news_channels"],
                source_online_news_blogs=form.cleaned_data["source_online_news_blogs"],
                source_newspapers=form.cleaned_data["source_newspapers"],
